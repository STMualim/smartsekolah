            ...
            <div class="col-xl-4 col-lg-12">
                <div class="card overflow-hidden">
                    ...
                    <div class="card-footer">
                        ...
                        <dl>
                        <dt>Manual Book</dt>
                        <dd><a href="#" target="_blank">Link Panduan</a></dd>
                        <dt>Demo Smartschool</dt>
                        <dd><a href="#" target="_blank">Link Akun Demo</a></dd>
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body"><img src="<?php echo base_url() ?>/assets/images/logokelulusan.png" alt="Logo For Kids">
                                        <ol>
                                            ...
                                            <li>Perbaikan Dan Penambahan Fitur Pada Guru</li>
                                            <li>Perbaikan Dan Penambahan Fitur Pada Siswa</li>
                                            <li>Perbaikan Data Kelas Yang Lebih Terstruktur</li>
                                            <li>Pemilihan Kelas Siswa Berdasarkan Kode Kelas</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="text-center">
                        <h3 class="mt-3">Selamat Datang Di <span class="text-primary">SmartSchool</span><sup>v<?php foreach($setting as $ver){ ?><?php echo $ver->version ?> <?php } ?></sup></h3>
                    </div>
                    <div class="carousel-inner text-center">
                        <div class="carousel-item active" data-interval="50000">
                            <img src="<?php echo base_url() ?>assets/images/model/welcome.svg" class="wid-250 my-4" alt="images">
                            <div class="row justify-content-center">
                                <div class="col-lg-9">
                                    <p class="f-16"><strong>SmartSchool <?php echo $ver->version ?></strong> Terus Dalam Penyempurnaan.</p>
                                    <p class="f-16"> Aplikasi SmartSchool - Aplikasi ini dikembangkan untuk menjadikan integrasi data yang tersusun dalam data center agar memudahkan pencarian dan manajemen data di Sekolah.</p>
                                    <div class="row justify-content-center text-left">
                                        <div class="col-md-10">
                                            ...
                                            <p class="mb-2 f-16"><i class="feather icon-check-circle mr-2 text-primary"></i> Pencatatan BK</p>
                                            <p class="mb-2 f-16"><i class="feather icon-check-circle mr-2 text-primary"></i> Pengelolaan Nilai</p>
                        ...
                        <div class="carousel-item" data-interval="50000">
                            <img src="<?php echo base_url() ?>assets/images/model/able-admin.jpg" class="img-fluid mt-0" alt="images">
                        </div>
                        <!-- <div class="carousel-item" data-interval="50000">
