		...
		<div class="navbar-wrapper  ">
			<div class="navbar-content scroll-div " >
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item">
						<a href="<?php echo base_url() ?>bk/dashboard" class="nav-link ">
					...
					<li class="nav-item pcoded-hasmenu">
						...
						<ul class="pcoded-submenu">
                            <li><a href="<?php echo base_url() ?>bk/dashboard/datapesertadidik">Data Siswa</a></li>
						</ul>
					</li>
					...
					<li class="nav-item pcoded-hasmenu">
						<a href="#!" class="nav-link ">
							...
							<span class="pcoded-mtext">Undangan</span>
						</a>
						<ul class="pcoded-submenu">
                            <li><a href="<?php echo base_url() ?>bk/dashboard/undanganortu">Surat Panggilan</a></li>
...
-->
					...
					<li class="nav-item pcoded-hasmenu">
						...
						<ul class="pcoded-submenu">
                            <li><a href="<?php echo base_url() ?>bk/dashboard/datakategoripelanggaran">Kategori Pelanggaran</a></li>
							<li><a href="<?php echo base_url() ?>bk/dashboard/datapelanggaran">Pelanggaran Siswa</a></li>
						</ul>
					</li>

          			<li class="nav-item"><a href="<?php echo base_url() ?>bk/dashboard/logout" class="nav-link ">
				...
				<div class="card text-center">
					<div class="card-block">
						...
						<p>Silahkan hubungi guru anda bila menemui masalah</p>
