                        ...
                        <div class="card bg-transparent border-0">
                            <div class="card-header bg-transparent border-0 text-center px-0 my-4">
                                <h2 class="card-title c-t-2 c-t-grad-2 mb-0">
                                    Video Profil Sekolah MTS Almujahidin
                                </h2>
                            </div>
        ...
        <div class="boxleft-benefits">
          ...
          <div class="boxleft-item-wrap">
            <div class="boxleft-item">
              <img src="<?php echo base_url() ?>assets/beranda/image/video" alt="icon video belajar adaftif">
              <p>
                Video belajar adaptif
              </p>
            </div>
             <div class="boxleft-item">
             <img src="<?php echo base_url() ?>assets/beranda/image/quiz" alt="icon kuis di tiap video">
              <p>
                Kuis di tiap video
              </p>
            </div>
             ...
             <div class="boxleft-item">
             <img src="<?php echo base_url() ?>assets/beranda/image/book" alt="icon Rangkuman &amp; infografik">
              <p>
                Rangkuman &amp; infografik 
              </p>
            </div>
             <div class="boxleft-item">
             <img src="<?php echo base_url() ?>assets/beranda/image/quiz1" alt="icon Kuis akhir di tiap subbab">
              <p>
        ...
        <div class="produk-rg__content">
            ...
            <?php foreach($buku as $res){ ?>
                ...
                <div class="produk-item" data-aos="fade-right">
                    <div class="prod-left">
                        <div class="logo-prod">
                            <img loading="lazy" src="<?php echo base_url() ?>/assets/images/logokelulusan" alt="Logo Roboguru Ruangguru">
                        </div>
                        <div class="illust-mob hp">
                            <img loading="lazy" src="<?php echo base_url() ?>assets/beranda/image/Misel" alt="Ilustrasi Roboguru Ruangguru">
                        </div>
